...
int main(int argc, char** argv)
{
    ...
    for (int i = 0; i < 100; ++i) {
        ...
        std::future<int> result1 = std::async(accum, 1, 2500);
        std::future<int> result2 = std::async(accum, 2501, 5000);
        std::future<int> result3 = std::async(accum, 5001, 7500);
        std::future<int> result4 = std::async(accum, 7501, 10000);
